...
default_attributes(
                   'java' => {
                      ...
                      "jdk" => {
                         "6" => {
                            "x86_64" => {
                                "url" => "http://192.168.87.1:8080/jdk-6u35-linux-x64.bin",
                                "checksum" => "13c6d118e0f923c5dbaed49bdfd82857be7453c831000088305d47182bfad089", # sha256 checksum
                            }
                         }
                      },
                   },
...
run_list(
        ...
        #"recipe[selinux::disabled]",  #turn off selinux
        #"recipe[apparmor]",  #turn off apparmor
        #"recipe[iptables::disabled]", #turn off iptables
